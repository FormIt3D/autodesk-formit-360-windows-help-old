...
* [Plugins](plug-ins/README.md)
  ...
  * [How to Develop Plugins](plug-ins/how-to-develop-plug-ins/README.md)
    ...
    * [Advanced options](plug-ins/how-to-develop-plug-ins/advanced-options/README.md)
      * [Enable development window in FormIt desktop app](plug-ins/how-to-develop-plug-ins/advanced-options/enable-development-window-in-formit-desktop-app.md)
      * [Plugin setup with manifest.json](plug-ins/how-to-develop-plug-ins/advanced-options/plugin-setup-with-manifest.json.md)
      * [Creating a Toolbar Plugin](plug-ins/how-to-develop-plug-ins/advanced-options/creating-a-toolbar-plugin.md)
      * [Testing toolbar plug-in html plug-in](plug-ins/how-to-develop-plug-ins/advanced-options/testing-toolbar-plug-in-html-plug-in.md)
      * [Creating an HTML Panel Plugin](plug-ins/how-to-develop-plug-ins/advanced-options/creating-an-html-panel-plugin.md)
      * [Creating a Combined HTML Panel and Toolbar with One Manifest](plug-ins/how-to-develop-plug-ins/advanced-options/creating-a-combined-html-panel-and-toolbar-with-one-manifest.md)
