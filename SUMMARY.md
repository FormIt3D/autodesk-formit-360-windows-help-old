...
* [Plugins](plug-ins/README.md)
  * [Introduction to Plugins](plug-ins/introduction.md)
    ...
    * [How to Contact Us if You Need Any Help?](plug-ins/introduction/how-to-contact-us-if-you-need-any-help.md)
  ...
  * [How to Develop Plugins](plug-ins/how-to-develop-plug-ins/README.md)
    * [Build your first FormIt Plugin](plug-ins/how-to-develop-plug-ins/build-your-first-formit-plugin/README.md)
      * [Using Plugin Playground](plug-ins/how-to-develop-plug-ins/build-your-first-formit-plugin/using-plugin-playground.md)
      * [Install Plugin Playground](plug-ins/how-to-develop-plug-ins/build-your-first-formit-plugin/install-plugin-playground.md)
      * [View and edit sample code](plug-ins/how-to-develop-plug-ins/build-your-first-formit-plugin/view-and-edit-sample-code.md)
      * [Add your own feature](plug-ins/how-to-develop-plug-ins/build-your-first-formit-plugin/add-your-own-feature.md)
      * [Saving your work to your GitHub account](plug-ins/how-to-develop-plug-ins/build-your-first-formit-plugin/saving-your-work-to-your-github-account.md)
      * [Publish your project](plug-ins/how-to-develop-plug-ins/build-your-first-formit-plugin/publish-your-project.md)
      ...
      * [Community & FormIt forum](plug-ins/how-to-develop-plug-ins/build-your-first-formit-plugin/community-and-formit-forum.md)
    ...
    * [Advanced options](plug-ins/how-to-develop-plug-ins/advanced-options/README.md)
      * [Enable development window in FormIt desktop app](plug-ins/how-to-develop-plug-ins/advanced-options/test-and-build.md)
      * [Plugin setup with manifest.json](plug-ins/how-to-develop-plug-ins/advanced-options/general-plugin-setup.md)
      * [Creating Toolbar-based Plugin](plug-ins/how-to-develop-plug-ins/advanced-options/creating-toolbar-based-plugin.md)
      * [Creating an HTML Panel-based Plugin](plug-ins/how-to-develop-plug-ins/advanced-options/creating-an-html-panel-based-plugin.md)
      * [Creating an Add-In](plug-ins/how-to-develop-plug-ins/advanced-options/creating-an-add-in.md)
      * [Creating a combined HTML Panel-based plugin and Toolbar-based plugin with one manifest](plug-ins/how-to-develop-plug-ins/advanced-options/creating-a-combined-html-panel-based-plugin-and-toolbar-based-plugin-with-one-manifest.md)
      * [Versioning](plug-ins/how-to-develop-plug-ins/advanced-options/versioning.md)
      * [Testing Toolbar-based plugin HTML Panel-based plugin](plug-ins/how-to-develop-plug-ins/advanced-options/testing-toolbar-based-plugin-html-panel-based-plugin.md)
      * [Debugging](plug-ins/how-to-develop-plug-ins/advanced-options/debugging.md)
      * [Load panel-based and toolbar-based plugin](plug-ins/how-to-develop-plug-ins/advanced-options/load-panel-based-and-toolbar-based-plugin/README.md)
