...
* [Plugins](plug-ins/README.md)
  ...
  * [How to Use Plugins](plug-ins/how-to-use-plug-ins/README.md)
    * [Plugin Manager](plug-ins/how-to-use-plug-ins/the-plugin-manager.md)
    * [Installing Plugins](plug-ins/how-to-use-plug-ins/install-plugins.md)
    * [Using Plugins](plug-ins/how-to-use-plug-ins/using-a-basic-plugin.md)
  * [How to Develop Plugins](plug-ins/how-to-develop-plug-ins/README.md)
    * [Your First Plugin](plug-ins/how-to-develop-plug-ins/build-your-first-plugin/README.md)
      * [Plugin Playground](plug-ins/how-to-develop-plug-ins/build-your-first-plugin/setting-the-plugin-playground.md)
      * [Launching the Sample Plugin](plug-ins/how-to-develop-plug-ins/build-your-first-plugin/view-and-edit-sample-code.md)
      * [Adding Your Own Features](plug-ins/how-to-develop-plug-ins/build-your-first-plugin/add-your-own-feature.md)
      * [Saving Your Work to GitHub](plug-ins/how-to-develop-plug-ins/build-your-first-plugin/saving-your-work-to-github.md)
      * [Publishing Your Project](plug-ins/how-to-develop-plug-ins/build-your-first-plugin/publish-your-project.md)
    * [Advanced Development](plug-ins/how-to-develop-plug-ins/advanced-development/README.md)
      * [Using an IDE](plug-ins/how-to-develop-plug-ins/advanced-development/using-an-ide.md)
      * [Cloning a Sample Plugin](plug-ins/how-to-develop-plug-ins/advanced-development/cloning-a-sample-plugin.md)
      * [Hosting a Plugin in the Local Server](plug-ins/how-to-develop-plug-ins/advanced-development/hosting-a-plugin-in-the-local-server.md)
      ...
      * [Set up an IDE and cloning](plug-ins/how-to-develop-plug-ins/advanced-development/set-up-an-ide-and-cloning.md)
      * [Additional Options](plug-ins/how-to-develop-plug-ins/advanced-development/additional-options/README.md)
        * [Naming and configure your plugin with manifest.json](plug-ins/how-to-develop-plug-ins/advanced-development/additional-options/naming-and-configure-your-plugin-with-manifest.json.md)
        * [Creating Toolbar-based Plugin](plug-ins/how-to-develop-plug-ins/advanced-development/additional-options/creating-toolbar-based-plugin.md)
        * [Creating an HTML Panel-based Plugin](plug-ins/how-to-develop-plug-ins/advanced-development/additional-options/creating-an-html-panel-based-plugin.md)
        * [Creating an Add-In](plug-ins/how-to-develop-plug-ins/advanced-development/additional-options/creating-an-add-in.md)
        * [Creating a combined HTML Panel-based plugin and Toolbar-based plugin with one manifest](plug-ins/how-to-develop-plug-ins/advanced-development/additional-options/creating-a-combined-html-panel-based-plugin-and-toolbar-based-plugin-with-one-manifest.md)
        * [Testing Toolbar-based plugin HTML Panel-based plugin](plug-ins/how-to-develop-plug-ins/advanced-development/additional-options/testing-toolbar-based-plugin-html-panel-based-plugin.md)
        * [Debugging](plug-ins/how-to-develop-plug-ins/advanced-development/additional-options/debugging.md)
        * [Versioning](plug-ins/how-to-develop-plug-ins/advanced-development/additional-options/versioning.md)
